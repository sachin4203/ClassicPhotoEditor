...
namespace FilterEffects
{
    ...
    public partial class PreviewPage : PhoneApplicationPage
    {
        ...
        private void CreateFilters()
        {
            ...
            _filters.Add(new MynewFilter());
            _filters.Add(new MynewFilter1());
            _filters.Add(new MynewFilter2());
            _filters.Add(new MynewFilter3());
            _filters.Add(new MynewFilter4());
            _filters.Add(new MynewFilter5());
        }
